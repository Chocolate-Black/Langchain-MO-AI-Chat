...
MODEL_ROOT_PATH = "./pretrain_models"
...
MODEL_PATH = {
    "embed_model": {
        ...
        "bge-large-zh-v1.5": "./pretrain_models/bge-large-zh-v1.5",

        # 本项目使用bge-m3作为embedding模型
        "bge-m3": "./pretrain_models/bge-m3_Merge_Keywords_20240314_154525",
    ...
    "llm_model": {
        ...
        "chatglm3-6b": "./pretrain_models/chatglm3-6b",
