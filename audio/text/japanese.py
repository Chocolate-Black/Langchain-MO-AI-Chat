...
from audio.text import punctuation, symbols
...
tokenizer = AutoTokenizer.from_pretrained("./audio/bert/deberta-v2-large-japanese-char-wwm")
...
if __name__ == "__main__":
    ...
    from audio.text.japanese_bert import get_bert_feature
